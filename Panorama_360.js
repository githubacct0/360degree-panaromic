...
(function() {
    ...
    var sceneURL = params.load ? params.load : '__URL__Panorama_360.gltf'.replace('__URL__', '');
    if (!sceneURL) {
...
function prepareExternalInterface(app) {
    ...
    // }
    app.ExternalInterface.openRightMenu = function(){
        var nameWrap = document.querySelector('.name-wrap');
        var nameOverlay = document.querySelector('.name-overlay');
        nameWrap.classList.remove('name-wrap-animate-delete');
        nameOverlay.classList.remove('name-wrap-animate-delete');
        nameWrap.classList.add('name-wrap-animate');
        nameOverlay.classList.add('name-wrap-animate');
    }

    app.ExternalInterface.closeRightMenu = function(){
        var nameWrap = document.querySelector('.name-wrap');
        var nameOverlay = document.querySelector('.name-overlay');
        nameWrap.classList.remove('name-wrap-animate-delete');
        nameOverlay.classList.remove('name-wrap-animate-delete');
        nameWrap.classList.add('name-wrap-animate-delete');
        nameOverlay.classList.add('name-wrap-animate-delete');
    }
}

function runCode(app) {
    // add your code here, e.g. console.log('Hello, World!');
    var searchBtn = document.querySelector('.search-btn-wrap');
    var searchWrap = document.querySelector('.search-wrap');
    var searchOverlay = document.querySelector('.search-overlay');

    searchBtn.addEventListener('click', function(){
        searchBtn.style.display = 'none';
        searchWrap.classList.remove('search-wrap-animate');
        searchWrap.classList.remove('search-wrap-animate-delete');
        searchOverlay.classList.remove('search-wrap-animate');
        searchOverlay.classList.remove('search-wrap-animate-delete');

        searchWrap.classList.add('search-wrap-animate');
        searchOverlay.classList.add('search-wrap-animate');
    });
    var searchClose = document.querySelector('.search-close-icon');
    searchClose.addEventListener('click', function(){
        searchBtn.style.display = 'flex';
        var searchWrap = document.querySelector('.search-wrap');
        var searchOverlay = document.querySelector('.search-overlay');
        searchWrap.classList.add('search-wrap-animate-delete');
        searchOverlay.classList.add('search-wrap-animate-delete');
    });

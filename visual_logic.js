 ...
 * Mon Oct 12 2020 11:09:44 GMT+0300 (Москва, стандартное время)
...
_initGlob.output.initOptions.preloaderProgressCb = function(percentage) {
    ...
    (function() {
  setHTMLElemAttribute('innerHTML', String(Math.round(_initGlob.percentage)) + '%', 'loading_text', false);
  setHTMLElemStyle('width', String(Math.round(_initGlob.percentage)) + '%', 'loading_bar', false);
})();
};
...
registerOnHover('Cylinder', function() {
  setHTMLElemStyle('cursor', 'pointer', ['BODY'], false);
}, function() {
  setHTMLElemStyle('cursor', 'default', ['BODY'], false);
});

eventHTMLElem('mousedown', 'volume-up', true, function(event) {
  playSound(loadMedia_HTML5('./birds.mp3'), true);
  console.log('Played');
});
eventHTMLElem('mousedown', 'volume-mute', true, function(event) {
  stopSound(loadMedia_HTML5('./birds.mp3'));
  console.log('Stoped');
});

eventHTMLElem('mousedown', 'name-wrap-close', true, function(event) {
  getJSFunction('closeRightMenu')();
});

registerOnClick('Cylinder', function() {
  console.log(_pGlob.pickedObject);
  getJSFunction('openRightMenu')();
}, function() {});
